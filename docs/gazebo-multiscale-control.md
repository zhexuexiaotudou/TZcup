...
→ EXECUTING_SWATH / EXECUTING_TURN → REPAIR_TRANSIT / REPAIR_SWATH → COMPLETED
```
...
| 参数 | 场景尺寸 | 用途 | 主要内容 |
|---|---:|---|---|
| `small` | 16 m × 12 m | 独立小场快速演示 | 橙色 30 m² 外任务区、青色 12 m² 实际清扫区、充电位、路缘、护栏、行人假人、积水，以及五类共 10 个可移除清扫目标 |
...
小场地的橙色大框是全部外任务区，青色小框及半透明填充才是车辆必须遍历的
