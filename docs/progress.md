...
- 新增[高保真竞赛清扫车虚拟样机规划](high-fidelity-competition-vehicle-plan.md)，把Husky A300定义为通过载荷、重心、供电、效率和通道门后才能冻结的条件候选；正式profile包含UTM-30LX、MID-360、前向RGB-D、两个侧后鱼眼、末端相机、UR5e、2F-85、征程6/S100、45 L干垃圾箱和完整刷盘/刮吸/污水箱总成。
- 冻结积水回收的质量守恒口径：刷盘只负责汇聚，刮水胶条和受真实泵曲线限制的吸口回收水；地面体积扣减必须等量增加污水箱液位和整车质量。20,000 m²主场采用可运行的连续水层，微型场才使用细粒度流体；视觉隐藏或直接删除积水不计为完成。
- 冻结3 cm立方体的纸板、PP、PET、铝材料随机质量方案；方块在投箱后仍保留为刚体，使垃圾箱质量和组合重心随任务增长。密度范围是规划初值，实施前仍须以材料数据表锁定。
- 可行性结论为“高保真名义数字样机可行、A300条件可行、全场粒子流体和未经实物标定的单位级数字孪生不可承诺”。当前只完成方案文档，没有下载模型、制作URDF/CAD、编写插件或运行新仿真；污水容量、湿区效率口径和项目自建开源CAD边界仍待用户确认。
