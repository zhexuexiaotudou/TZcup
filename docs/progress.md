...
- 修正干湿箱、投放通道和后车身碰撞：干箱可用容积 39.9566 L、污水箱有效容量 9.7064 L，车身侵入均为 0；30 mm 方块投放路径最小净空 73.64 mm。机械臂验收使用同一个 PET 刚体完成双指接触、0.260000 m 抬升、释放、落箱和持续承载接触，不在任务中删除或重置垃圾实体。
