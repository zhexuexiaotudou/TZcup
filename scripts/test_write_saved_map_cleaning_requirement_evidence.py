...
def test_requirement_evidence_binds_one_identity_and_records_missing(tmp_path, monkeypatch):
    ...
    _write(runtime, {"amcl_pose_sample_count": 2, "nav2_action_ready": True, "coverage_first_brush_enabled_monotonic_s": 1.0, "brush_enabled_distance_m": 3.0, "trajectory_total_distance_m": 4.0, "coverage_action_terminal_passed": True, "planning_proxy_coverage_fraction": 0.95, "coverage_metric_basis": "amcl_base_centerline_planning_proxy_not_actual_swept_area"})
