...
def main() -> int:
    ...
    evidence = {
        ...
        "requirements": [
            ...
            row("coverage_progress", progress, "collect_formal_map_lifecycle_runtime", args.cleaning_runtime, runtime_sha, {"brush_enabled_distance_m": runtime.get("brush_enabled_distance_m", 0.0), "trajectory_total_distance_m": runtime.get("trajectory_total_distance_m", 0.0), "planning_proxy_coverage_ratio": runtime.get("planning_proxy_coverage_fraction"), "coverage_metric_basis": runtime.get("coverage_metric_basis")}, "nonzero brush-enabled trajectory not observed"),
            row("coverage_complete", completed, "coverage_execution_and_route_sanity", args.coverage_report, coverage_sha, {"coverage_action_terminal_passed": runtime.get("coverage_action_terminal_passed"), "coverage_success": coverage.get("success"), "planning_proxy_coverage_ratio": runtime.get("planning_proxy_coverage_fraction"), "coverage_metric_basis": runtime.get("coverage_metric_basis"), "route_spacing_m": route.get("realized_lane_spacing_m"), "route_spacing_limit_m": route.get("recommended_max_lane_spacing_m"), "free_space_turn_continuity": not bool(route.get("disconnected_turn_rows")), "geofence_consumer_bundle_valid": route.get("passed") is True, "route_sanity_artifact_path": str(args.route_sanity), "route_sanity_artifact_sha256": route_sha, "return_home_observed": home}, "coverage terminal success and return-home closure not observed"),
