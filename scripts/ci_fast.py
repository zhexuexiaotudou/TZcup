...
def require_project_files() -> None:
    required = (
        ...
        ROOT / "docs" / "competition-simulation-only-execution.md",
        ...
        ROOT / "config" / "competition_sim_only_v1.json",
        ...
        ROOT / "scripts" / "validate_s100p_board_deployment_preflight.py",
        ROOT / "scripts" / "test_collect_s100p_g0_inventory.py",
        ROOT / "scripts" / "test_validate_s100p_board_deployment_preflight.py",
        ...
        SOURCE_ROOT / "sanitation_gazebo_control" / "src" / "A300DrivetrainNativeBridge.cc",
        ...
        ROOT / "scripts" / "formal_a19_product_adapter.py",
        ...
        ROOT / "scripts" / "public_gazebo_dosod_calibration.py",
        ROOT / "scripts" / "run_public_mobile_gazebo_dosod_calibration.sh",
        ROOT / "scripts" / "run_public_gazebo_camera_readiness_smoke.sh",
        ROOT / "scripts" / "public_gazebo_camera_pair_readiness.py",
        ROOT / "scripts" / "test_public_gazebo_camera_readiness_smoke.py",
        ROOT / "scripts" / "test_public_gazebo_dosod_calibration.py",
        ROOT / "scripts" / "test_public_gazebo_camera_readiness_smoke.py",
        ...
        ROOT / "scripts" / "test_formal_a19_product_adapter.py",
...
def run_ros_independent_tests() -> None:
    ...
    test_paths = (
        ...
        ROOT / "scripts" / "test_replay_competition_perception_model.py",
        ROOT / "scripts" / "test_replay_controlled_perception_policy.py",
        ROOT / "scripts" / "test_calibrate_controlled_perception_gpu.py",
        ROOT / "scripts" / "test_perception_gpu_recovery_receipt.py",
        ...
        *sorted((research_demo_package / "test").glob("test_*.py")),
        ...
        ROOT / "scripts" / "test_dosod_hbm_abi_contract.py",
        ROOT / "scripts" / "test_dosod_hbm_disas_receipt.py",
        ROOT / "scripts" / "test_hbm_evidence_producers.py",
        ROOT / "scripts" / "test_dosod_single_frame_preprocessing_oracle.py",
        ROOT / "scripts" / "test_run_dosod_official_preprocess_capture.py",
        ROOT / "scripts" / "test_dosod_oracle_watchdog.py",
        ...
        ROOT / "scripts" / "test_formal_goal_acceptance_crosswalk.py",
        ...
        ROOT / "scripts" / "test_prepare_competition_sim_only_evidence.py",
        ROOT / "scripts" / "test_preflight_product_perception_startup.py",
        ROOT / "scripts" / "test_run_competition_sim_only_cleaning.py",
        ROOT / "scripts" / "test_validate_competition_sim_only_cleaning.py",
