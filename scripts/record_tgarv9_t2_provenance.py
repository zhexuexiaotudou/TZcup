...
def main() -> int:
    ...
    hypothesis = {
        ...
        "protocol": "TGARV9",
        "stage": "T2_HYPOTHESIS",
        "trigger": "Strict prediction-driven T1 observed nearly all actionable tubes but failed class separation, small recall, actionable precision, clean-opportunity recall, and false-clean safety",
        "T1_observation_recall": 0.9874213836477987,
        "T1_correct_class_recall": 0.7044025157232704,
        "T1_small_correct_class_recall": 0.7745098039215687,
        "T1_confirmed_actionable_precision": 0.6153846153846154,
        "T1_false_CLEAN_NOW": 70,
        "hypothesis": "RTMDet dense one-stage class separation and fragmented false tracks limit small and hard-negative real-Gazebo safety; query-based multi-scale DINO tests a materially different detection bias while retaining the same prediction-only map association and track-level evidence",
