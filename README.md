...
| 学习感知 | 恢复推进中 | AUTO-05R-1 G4 正式数据门已通过（12 worlds/300 scenes/3000 frames，strict QA `G4_dataset_gate_pass=true`）；AUTO-05R-2/3 模型与训练协议代码已就绪，真实训练未执行；AUTO-05 历史=BLOCKED，AUTO-06/07/08 未通过 |
