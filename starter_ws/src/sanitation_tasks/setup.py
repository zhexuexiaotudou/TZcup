...
setup(
    ...
    data_files=[
        ...
        ("share/" + package_name + "/config", [
            ...
            "config/competition_ackermann_demo_area.yaml",
    ...
    entry_points={
        "console_scripts": [
            ...
            "sanitation_frontier_explorer = sanitation_tasks.frontier_explorer:main",
            "sanitation_tf_continuity_probe = sanitation_tasks.tf_continuity_probe:main",
